...
#          second arg is index of first character of substring
#          third arg is index last character of substring
substr(t[3],4,6)
...
######  We will only touch on regular expresions in this class
...
t = c("123256","2456.7","three","over","same",
      "Ab","aA","AC","AAA","2222","22 222")
...
r = c("wherever","sunny","everywhere","somewhere","screech","bookkeepers","someday",
       "s is the sum")
