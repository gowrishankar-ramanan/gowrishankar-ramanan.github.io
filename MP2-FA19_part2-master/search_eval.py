...
class InL2Ranker(metapy.index.RankingFunction):
    ...
    def score_one(self, sd):
        ...
        lda = (sd.num_docs + 1) / (sd.corpus_term_count + 0.5)
        if lda < 1 or tfn <= 0:
            return 0.0
        score = sd.query_term_weight * (tfn / (tfn + self.param)) * math.log(lda, 2)
...
if __name__ == '__main__':
    ...
    avg_p_list = []
    #avg_p_txt_file = 'inl2.avg_p.txt'
    avg_p_txt_file = 'bm25.avg_p.txt'
    ...
    write_lst(avg_p_list,avg_p_txt_file)
